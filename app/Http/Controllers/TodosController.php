...
class TodosController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // Create Todo
        $todo = new Todo;
        $todo->custumer_id = $request->input('custumer_id');
        $todo->custumer_name = $request->input('custumer_name');
    ...
    {
        $todo = Todo::find($id);
        $todo->costumer_id = $request->input('costumer_id');
        $todo->custumer_name = $request->input('costumer_name');
        $todo->username = $request->input('username');
        $todo->password = $request->input('password');
